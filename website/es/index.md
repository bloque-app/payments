...
hero:
  ...
  actions:
    - theme: brand
      text: Introducción
      link: /pay/guide/start/introduction
    - theme: alt
      text: Inicio Rápido
...
features:
  ...
  - title: Componentes React
    ...
    icon: ⚛️
  - title: SDK Type-Safe
    details: Diseño TypeScript-first con tipos de unión discriminada y soporte completo de IntelliSense para mejor experiencia de desarrollador.
    icon: 📱
